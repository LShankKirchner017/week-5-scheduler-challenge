// TODO: Add a listener for click events on the save button.
  ...
  // How can DOM traversal be used to get the "hour-x" id of the time-block containing the button that was clicked? (we use .parent to move up to the hour id from the save btn class)
...
// TODO: Add code to apply the past, present, or future class to each time block by comparing the id to the current hour. 
  ...
  How can Day.js be used to get the current hour in 24-hour time? [X]
